...
def fcs_in_workspace(inputFolder):
        ...
        for fileName in files:
            if fileName.endswith(suffix):
                ...
                for fc in fclist:
                    ...
                    elif name == "Marital_Families_Households_DA":
    ...
    for fc in fclist:
        ...
        if name == duplicated_name("Income_Earnings_DA", 0):
            ...
            keepFields = ["FID", "Shape", "DAUID", "CSDUID", "CCSUID", "CDUID", "ERUID", "PRUID", "CTUID", "CMAUID", "OID_", "GEOGRAPHY", "PREVALE14", "TFvariable", "Z_score"]
            zero_process0(path, "PREVALE14")
            expression0 = "!PREVALE14!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Low_Income_Income_2006_DA.shp"
        elif name == duplicated_name("Income_Earnings_DA", 2):
            keepFields = ["FID", "Shape", "DAUID", "CSDUID", "CCSUID", "CDUID", "ERUID", "PRUID", "CTUID", "CMAUID", "OID_", "GEOGRAPHY", "GOVERNMENT", "TFvariable", "Z_score"]
            ...
            keepFields = ["FID", "Shape", "DAUID", "CSDUID", "CCSUID", "CDUID", "ERUID", "PRUID", "CTUID", "CMAUID", "OID_", "GEOGRAPHY", "UNEMPLOYED", "IN_THE_LAB", "TFvariable", "Z_score"]
            ...
            keepFields = ["FID", "Shape", "DAUID", "CSDUID", "CCSUID", "CDUID", "ERUID", "PRUID", "CTUID", "CMAUID", "OID_", "GEOGRAPHY", "2001_TO_20", "TOTAL_PO6", "TFvariable", "Z_score"]
            zero_process1(path, "2001_TO_20", "TOTAL_PO6")
            ...
            keepFields = ["FID", "Shape", "DAUID", "CSDUID", "CCSUID", "CDUID", "ERUID", "PRUID", "CTUID", "CMAUID", "OID_", "GEOGRAPHY", "NEITHER_EN", "TOTAL_PO2", "TFvariable", "Z_score"]
            zero_process1(path, "NEITHER_EN", "TOTAL_PO2")
            ...
            keepFields = ["FID", "Shape", "DAUID", "CSDUID", "CCSUID", "CDUID", "ERUID", "PRUID", "CTUID", "CMAUID", "OID_", "GEOGRAPHY", "CANADIAN_C", "TOTAL_PO5", "TFvariable", "Z_score"]
            zero_process1(path, "CANADIAN_C", "TOTAL_PO5")
            expression0 = "!CANADIAN_C! / !TOTAL_PO5!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Canadian_Citizen_Language_2006_DA.shp"
        elif name == duplicated_name("Marital_Families_Households_DA", 0):
            keepFields = ["FID", "Shape", "DAUID", "CSDUID", "CCSUID", "CDUID", "ERUID", "PRUID", "CTUID", "CMAUID", "OID_", "GEOGRAPHY", "RENTED", "TOTAL_NU6", "TFvariable", "Z_score"]
            zero_process1(path, "RENTED", "TOTAL_NU6")
            expression0 = "!RENTED! / !TOTAL_NU6!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Dwellings_Rental_Marital_2006_DA.shp"
        elif name == duplicated_name("Marital_Families_Households_DA", 1):
            keepFields = ["FID", "Shape", "DAUID", "CSDUID", "CCSUID", "CDUID", "ERUID", "PRUID", "CTUID", "CMAUID", "OID_", "GEOGRAPHY", "TOTAL_LONE", "TOTAL_NUMB", "TFvariable", "Z_score"]
            zero_process1(path, "TOTAL_LONE", "TOTAL_NUMB")
            expression0 = "!TOTAL_LONE! / !TOTAL_NUMB!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Lone_Parent_Marital_2006_DA.shp"
        elif name == duplicated_name("Marital_Families_Households_DA", 2):
            keepFields = ["FID", "Shape", "DAUID", "CSDUID", "CCSUID", "CDUID", "ERUID", "PRUID", "CTUID", "CMAUID", "OID_", "GEOGRAPHY", "LIVING_AL1", "TOTAL_NU4", "TFvariable", "Z_score"]
            zero_process1(path, "LIVING_AL1", "TOTAL_NU4")
            expression0 = "!LIVING_AL1! / !TOTAL_NU4!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Living_Alone_Marital_2006_DA.shp"
        elif name == duplicated_name("Marital_Families_Households_DA", 3):
            keepFields = ["FID", "Shape", "DAUID", "CSDUID", "CCSUID", "CDUID", "ERUID", "PRUID", "CTUID", "CMAUID", "OID_", "GEOGRAPHY", "MAJOR_REPA", "TOTAL_NU7", "TFvariable", "Z_score"]
            zero_process1(path, "MAJOR_REPA", "TOTAL_NU7")
            expression0 = "!MAJOR_REPA! / !TOTAL_NU7!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Dwellings_Major_Repair_Marital_2006_DA.shp"
        elif name == duplicated_name("Marital_Families_Households_DA", 4):
            keepFields = ["FID", "Shape", "DAUID", "CSDUID", "CCSUID", "CDUID", "ERUID", "PRUID", "CTUID", "CMAUID", "OID_", "GEOGRAPHY", "MOVABLE_DW", "TOTAL_NU9", "TFvariable", "Z_score"]
            zero_process1(path, "MOVABLE_DW", "TOTAL_NU9")
            expression0 = "!MOVABLE_DW! / !TOTAL_NU9!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Dwellings_Mobile_Marital_2006_DA.shp"
        elif name == duplicated_name("Marital_Families_Households_DA", 5):
            keepFields = ["FID", "Shape", "DAUID", "CSDUID", "CCSUID", "CDUID", "ERUID", "PRUID", "CTUID", "CMAUID", "OID_", "GEOGRAPHY", "PERIOD_OF_", "PERIOD_OF1", "TOTAL_NU8", "TFvariable", "Z_score"]
            zero_process2(path, "PERIOD_OF_", "PERIOD_OF1", "TOTAL_NU8")
            ...
            keepFields = ["FID", "Shape", "CTUID", "CMAUID", "PRUID", "CT_UID", "OID_", "GEOGRAPHY", "PREVALE14", "TFvariable", "Z_score"]
            zero_process0(path, "PREVALE14")
            expression0 = "!PREVALE14!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            keepFields = ["FID", "Shape", "CTUID", "CMAUID", "PRUID", "CT_UID", "OID_", "GEOGRAPHY", "UNEMPLOYED", "IN_THE_LAB", "TFvariable", "Z_score"]
            zero_process1(path, "UNEMPLOYED", "IN_THE_LAB")
            expression0 = "!UNEMPLOYED! / !IN_THE_LAB!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            keepFields = ["FID", "Shape", "CTUID", "CMAUID", "PRUID", "CT_UID", "OID_", "GEOGRAPHY", "2001_TO_20", "TOTAL_PO6", "TFvariable", "Z_score"]
            zero_process1(path, "2001_TO_20", "TOTAL_PO6")
            expression0 = "!2001_TO_20! / !TOTAL_PO6!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            keepFields = ["FID", "Shape", "CTUID", "CMAUID", "PRUID", "CT_UID", "OID_", "GEOGRAPHY", "NEITHER_EN", "TOTAL_PO2", "TFvariable", "Z_score"]
            zero_process1(path, "NEITHER_EN", "TOTAL_PO2")
            expression0 = "!NEITHER_EN! / !TOTAL_PO2!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            keepFields = ["FID", "Shape", "CTUID", "CMAUID", "PRUID", "CT_UID", "OID_", "GEOGRAPHY", "CANADIAN_C", "TOTAL_PO5", "TFvariable", "Z_score"]
            zero_process1(path, "CANADIAN_C", "TOTAL_PO5")
            expression0 = "!CANADIAN_C! / !TOTAL_PO5!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            keepFields = ["FID", "Shape", "CTUID", "CMAUID", "PRUID", "CT_UID", "OID_", "GEOGRAPHY", "RENTED", "TOTAL_NU4", "TFvariable", "Z_score"]
            zero_process1(path, "RENTED", "TOTAL_NU4")
            ...
            keepFields = ["FID", "Shape", "CTUID", "CMAUID", "PRUID", "CT_UID", "OID_", "GEOGRAPHY", "TOTAL_LONE", "TOTAL_NUMB", "TFvariable", "Z_score"]
            zero_process1(path, "TOTAL_LONE", "TOTAL_NUMB")
            expression0 = "!TOTAL_LONE! / !TOTAL_NUMB!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            keepFields = ["FID", "Shape", "CTUID", "CMAUID", "PRUID", "CT_UID", "OID_", "GEOGRAPHY", "LIVING_AL1", "TOTAL_NU4", "TFvariable", "Z_score"]
            zero_process1(path, "LIVING_AL1", "TOTAL_NU4")
            expression0 = "!LIVING_AL1! / !TOTAL_NU4!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            keepFields = ["FID", "Shape", "CTUID", "CMAUID", "PRUID", "CT_UID", "OID_", "GEOGRAPHY", "MAJOR_REPA", "TOTAL_NU7", "TFvariable", "Z_score"]
            zero_process1(path, "MAJOR_REPA", "TOTAL_NU7")
            expression0 = "!MAJOR_REPA! / !TOTAL_NU7!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            keepFields = ["FID", "Shape", "CTUID", "CMAUID", "PRUID", "CT_UID", "OID_", "GEOGRAPHY", "MOVABLE_DW", "TOTAL_NU9", "TFvariable", "Z_score"]
            zero_process1(path, "MOVABLE_DW", "TOTAL_NU9")
            expression0 = "!MOVABLE_DW! / !TOTAL_NU9!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            keepFields = ["FID", "Shape", "CTUID", "CMAUID", "PRUID", "CT_UID", "OID_", "GEOGRAPHY", "PERIOD_OF_", "PERIOD_OF1", "TOTAL_NU8", "TFvariable", "Z_score"]
            zero_process2(path, "PERIOD_OF_", "PERIOD_OF1", "TOTAL_NU8")
            expression0 = "(!PERIOD_OF_! + !PERIOD_OF1!)/ !TOTAL_NU8!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
