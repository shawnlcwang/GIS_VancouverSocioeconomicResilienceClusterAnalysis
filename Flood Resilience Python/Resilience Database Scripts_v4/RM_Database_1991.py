...
def fcs_in_workspace(inputFolder):
    ...
    for fc in fclist:
        ...
        if name == duplicated_name("Dwelling_households_EA", 0):
            ...
            zero_process1(path, "COL27", "COL34")
            ...
            zero_process2(path, "COL6", "COL13", "COL14")
            ...
            zero_process1(path, "COL47", "COL51")
            ...
            zero_process1(path, "COL43", "COL45")
            ...
            zero_process1(path, "COL4", "COL117")
            ...
            zero_process1(path, "COL47", "COL49")
            ...
            zero_process1(path, "COL70", "COL88")
            ...
            zero_process1(path, "COL111", "COL115")
            ...
            keepFields = ["FID", "Shape", "AREA", "PERIMETER", "G91CT0_", "G91CT0_ID", "CA", "CT_NAME", "PROV", "CA_CTNAME", "OID_", "COL138", "COL144", "TFvariable", "Z_score"]
            zero_process1(path, "COL138", "COL144")
            field_process1(path, "COL138_", "COL144_", "!COL138!", "!COL144!")
            expression0 = "!COL144_! / !COL138_!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            zero_process1(path, "COL47", "COL58")
            ...
            zero_process2(path, "COL138", "COL145", "COL146")
