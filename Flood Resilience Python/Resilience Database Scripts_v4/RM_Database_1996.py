...
def fcs_in_workspace(inputFolder):
    ...
    for fc in fclist:
        ...
        if name == duplicated_name("Income_EA", 0):
            ...
            zero_process1(path, "MAJOR_REPA", "TOTAL_NU4")
            ...
            zero_process2(path, "PERIOD_OF_", "PERIOD_OF1", "TOTAL_NU4")
            ...
            zero_process1(path, "1991_1996_", "TOTAL_POPU")
            ...
            zero_process1(path, "NEITHER_EN", "TOTAL_PO3")
            ...
            zero_process1(path, "CANADIAN_C", "TOTAL_POPU")
            ...
            zero_process1(path, "MOVABLE_DW", "TOTAL_NU4")
