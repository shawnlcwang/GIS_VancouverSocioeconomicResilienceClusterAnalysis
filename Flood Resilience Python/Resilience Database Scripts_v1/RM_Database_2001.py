...
outputFolder = "D:\\MSc Thesis\\CCAR Database\\2001\\Resilience_2001_Output"
...
def Tvariable_process(path):
    ...
    if name == duplicated_name("Citizenship_DA", 0):
        ...
        Tvariable_identify(path)
        cursor = arcpy.da.UpdateCursor(path, ["Total_po_1", "Tvariable"])
        for row in cursor:
            if row[0] == 0 or row[0] is None:
                row[0] = -9999
                row[1] = "Zero_Data"
        ...
        Tvariable_identify(path)
        cursor = arcpy.da.UpdateCursor(path, ["TOTAL_NU5", "Tvariable"])
        for row in cursor:
            if row[0] == 0 or row[0] is None:
                row[0] = -9999
                row[1] = "Zero_Data"
...
def fcs_in_workspace(inputFolder):
    ...
    for fc in fclist:
        ...
        if name == duplicated_name("Citizenship_DA", 0):
            keepFields = ["FID", "Shape", "DAUID", "COUNT", "FIRST_PRUI", "FIRST_CSDU", "FIRST_CMAU", "OID_", "GEOGRAPHY", "1996_2001", "TOTAL_POPU", "Tvariable", "TFvariable", "Z_score"]
            ...
            keepFields = ["FID", "Shape", "DAUID", "COUNT", "FIRST_PRUI", "FIRST_CSDU", "FIRST_CMAU", "OID_", "GEOGRAPHY", "CANADIAN_C", "TOTAL_POPU", "Tvariable", "TFvariable", "Z_score"]
            field_process1(path, "CANADA_C_", "TOTAL_POP_", "!CANADIAN_C!", "!TOTAL_POPU!")
            expression0 = "!CANADA_C_! / !TOTAL_POP_!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            keepFields = ["FID", "Shape", "DAUID", "COUNT", "FIRST_PRUI", "FIRST_CSDU", "FIRST_CMAU", "OID_", "GEOGRAPHY", "UNEMPLOYED", "IN_THE_LAB", "Tvariable", "TFvariable", "Z_score"]
            ...
            keepFields = ["FID", "Shape", "DAUID", "COUNT", "FIRST_PRUI", "FIRST_CSDU", "FIRST_CMAU", "OID_", "GEOGRAPHY", "RENTED", "TOTAL_NU4", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "!RENTED! / !TOTAL_NU4! "
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Dwellings_Rental_Martial_2001_DA.shp"
        elif name == duplicated_name("Marital_DA", 1):
            keepFields = ["FID", "Shape", "DAUID", "COUNT", "FIRST_PRUI", "FIRST_CSDU", "FIRST_CMAU", "OID_", "GEOGRAPHY", "TOTAL_LONE", "TOTAL_NUMB", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "!TOTAL_LONE! / !TOTAL_NUMB!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Lone_Parent_Martial_2001_DA.shp"
        elif name == duplicated_name("Marital_DA", 2):
            keepFields = ["FID", "Shape", "DAUID", "COUNT", "FIRST_PRUI", "FIRST_CSDU", "FIRST_CMAU", "OID_", "GEOGRAPHY", "LIVING_AL1", "TOTAL_NU3", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "!LIVING_AL1! / !TOTAL_NU3!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Living_Alone_Martial_2001_DA.shp"
        elif name == duplicated_name("Marital_DA", 3):
            keepFields = ["FID", "Shape", "DAUID", "COUNT", "FIRST_PRUI", "FIRST_CSDU", "FIRST_CMAU", "OID_", "GEOGRAPHY", "MAJOR_REPA", "TOTAL_NU4", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "!MAJOR_REPA! / !TOTAL_NU4!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Dwellings_Major_Repair_2001_DA.shp"
        elif name == duplicated_name("Marital_DA", 4):
            keepFields = ["FID", "Shape", "DAUID", "COUNT", "FIRST_PRUI", "FIRST_CSDU", "FIRST_CMAU", "OID_", "GEOGRAPHY", "MOVABLE_DW", "TOTAL_NU5", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "!MOVABLE_DW! / !TOTAL_NU5!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Dwellings_Mobile_Marital_2001_DA.shp"
        elif name == duplicated_name("Marital_DA", 5):
            keepFields = ["FID", "Shape", "DAUID", "COUNT", "FIRST_PRUI", "FIRST_CSDU", "FIRST_CMAU", "OID_", "GEOGRAPHY", "PERIOD_OF_", "PERIOD_OF1", "TOTAL_NU4", "Tvariable", "TFvariable", "Z_score"]
            ...
            keepFields = ["FID", "Shape", "CTUID", "COUNT", "FIRST_CTNA", "FIRST_CMAU", "FIRST_PRUI", "CT_UID", "OID_", "GEOGRAPHY", "1996_2001", "TOTAL_POPU", "Tvariable", "TFvariable", "Z_score"]
            field_process1(path, "_1996_2001", "TOTAL_POP_", "!1996_2001!", "!TOTAL_POPU!")
            expression0 = "!_1996_2001! / !TOTAL_POP_!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            keepFields = ["FID", "Shape", "CTUID", "COUNT", "FIRST_CTNA", "FIRST_CMAU", "FIRST_PRUI", "CT_UID", "OID_", "GEOGRAPHY", "CANADIAN_C", "TOTAL_POPU", "Tvariable", "TFvariable", "Z_score"]
            field_process1(path, "CANADA_C_", "TOTAL_POP_", "!CANADIAN_C!", "!TOTAL_POPU!")
            expression0 = "!CANADA_C_! / !TOTAL_POP_!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            ...
            keepFields = ["FID", "Shape", "CTUID", "COUNT", "FIRST_CTNA", "FIRST_CMAU", "FIRST_PRUI", "CT_UID", "OID_", "GEOGRAPHY", "UNEMPLOYED", "IN_THE_LAB", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "!UNEMPLOYED! / !IN_THE_LAB!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Labour_Unemployment_Labour_2001_CT.shp"
        elif name == duplicated_name("Language_CT", 0):
            keepFields = ["FID", "Shape", "CTUID", "COUNT", "FIRST_CTNA", "FIRST_CMAU", "FIRST_PRUI", "CT_UID", "OID_", "GEOGRAPHY", "Neither_En", "Total_po_1", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "!Neither_En! / !Total_po_1!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Neither_Language_Language_2001_CT.shp"
        elif name == duplicated_name("Marital_CT", 0):
            keepFields = ["FID", "Shape", "CTUID", "COUNT", "FIRST_CTNA", "FIRST_CMAU", "FIRST_PRUI", "CT_UID", "OID_", "GEOGRAPHY", "RENTED", "TOTAL_NU4", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "!RENTED! / !TOTAL_NU4!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Dwellings_Rental_Marital_2001_CT.shp"
        elif name == duplicated_name("Marital_CT", 1):
            keepFields = ["FID", "Shape", "CTUID", "COUNT", "FIRST_CTNA", "FIRST_CMAU", "FIRST_PRUI", "CT_UID", "OID_", "GEOGRAPHY", "TOTAL_LONE", "TOTAL_NUMB", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "!TOTAL_LONE! / !TOTAL_NUMB!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Lone_Parent_Marital_2001_CT.shp"
        elif name == duplicated_name("Marital_CT", 2):
            keepFields = ["FID", "Shape", "CTUID", "COUNT", "FIRST_CTNA", "FIRST_CMAU", "FIRST_PRUI", "CT_UID", "OID_", "GEOGRAPHY", "LIVING_AL1", "TOTAL_NU3", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "!LIVING_AL1! / !TOTAL_NU3!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Living_Alone_Marital_2001_CT.shp"
        elif name == duplicated_name("Marital_CT", 3):
            keepFields = ["FID", "Shape", "CTUID", "COUNT", "FIRST_CTNA", "FIRST_CMAU", "FIRST_PRUI", "CT_UID", "OID_", "GEOGRAPHY", "MAJOR_REPA", "TOTAL_NU4", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "!MAJOR_REPA! / !TOTAL_NU4!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Dwellings_Major_Repair_Marital_2001_CT.shp"
        elif name == duplicated_name("Marital_CT", 4):
            keepFields = ["FID", "Shape", "CTUID", "COUNT", "FIRST_CTNA", "FIRST_CMAU", "FIRST_PRUI", "CT_UID", "OID_", "GEOGRAPHY", "MOVABLE_DW", "TOTAL_NU5", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "!MOVABLE_DW! / !TOTAL_NU5!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
            newName = "Dwellings_Mobile_Marital_2001_CT.shp"
        elif name == duplicated_name("Marital_CT", 5):
            keepFields = ["FID", "Shape", "CTUID", "COUNT", "FIRST_CTNA", "FIRST_CMAU", "FIRST_PRUI", "CT_UID", "OID_", "GEOGRAPHY", "PERIOD_OF_", "PERIOD_OF1", "TOTAL_NU4", "Tvariable", "TFvariable", "Z_score"]
            expression0 = "(!PERIOD_OF_! + !PERIOD_OF1!)/ !TOTAL_NU4!"
            arcpy.CalculateField_management(path, "normalize", expression0, "PYTHON_9.3")
            expression1 = variable_calculate(path, "normalize")
